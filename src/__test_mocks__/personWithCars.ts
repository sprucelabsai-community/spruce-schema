...
export const untypedCarDefinition = buildSchemaDefinition({
	id: 'car',
	name: 'car',
	fields: {
		name: {
...
export const untypedTruckDefinition = buildSchemaDefinition({
	id: 'truck',
	name: 'Truck',
	fields: {
		name: {
...
export const untypedPersonDefinition = buildSchemaDefinition({
	id: 'person',
	name: 'user schema test',
	fields: {
		name: {
