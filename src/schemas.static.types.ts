...
>
    ...
    getValues<F extends string, CreateEntityInstances extends boolean = true>(
        options?: DynamicSchemaGetValuesOptions<
            ISchema,
            F,
            CreateEntityInstances
        >
...
export interface SchemaFieldValueUnion<
    ...
    Version extends string | undefined = undefined,
> {
    id: Id
    version?: Version
    values: V
...
export type SchemaDefaultValues<
    S extends Schema,
    CreateEntityInstances extends boolean = false,
    K extends SchemaFieldNamesWithDefaultValue<S> =
...
export type SchemaPublicValues<
    S extends Schema,
    CreateEntityInstances extends boolean = false,
    PublicFieldNames extends SchemaPublicFieldNames<S> =
...
export interface DynamicSchemaValidateOptions<
